/**
 * Created by briansmith on 01/03/2016.
 */
...
function init () {
  ...
  function updateCurveMarker () {
    ...
    var m = new Point(e.x / 2, e.y / 2) // midpoint
    var o = new Point(e.y, -e.x) // orthogonal
    var c = new Point(m.x + curvature * o.x, m.y + curvature * o.y) // curve control point
